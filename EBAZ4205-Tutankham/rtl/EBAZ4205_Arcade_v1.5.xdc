...
## DIPS
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { dipsw[0] }]; 
set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS33 } [get_ports { dipsw[1] }]; 
set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS33 } [get_ports { dipsw[2] }]; 
set_property -dict { PACKAGE_PIN G19   IOSTANDARD LVCMOS33 } [get_ports { dipsw[3] }]; 
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { dipsw[4] }]; 
